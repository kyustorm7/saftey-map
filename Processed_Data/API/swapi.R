##Get data from https://swapi.co/, an open-source Star Wars database. 
##Explore the GET response, parse with jsonlite, create a function to parse automatically, write a loop to process a paged response.
